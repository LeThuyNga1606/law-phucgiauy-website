        ...
        <div className="about-intro-container">
          ...
          <div className="about-intro-block">
            ...
            <div className="about-intro-img-wrap">
              <img src={intro1} alt={t("about_intro_img1_alt")} className="about-intro-img" />
            </div>
          </div>
          ...
          <div className="about-intro-block">
            ...
            <div className="about-intro-img-wrap">
              <img src={intro3} alt={t("about_intro_img2_alt")} className="about-intro-img" />
            </div>
          </div>
          ...
          <div className="about-intro-block">
            ...
            <div className="about-intro-img-wrap">
              <img src={intro2} alt={t("about_intro_img3_alt")} className="about-intro-img" />
            </div>
          </div>
